...
import com.xworkz.Association.inheritance.Place;
import com.xworkz.Association.inheritance.SiliconCity;
...
public class BengaluruRunner {
	...
	public static void main(String[] args) {
		...
		SiliconCity siliconcity = new Bengaluru();
		MetroCity metrocity = new Bengaluru();
