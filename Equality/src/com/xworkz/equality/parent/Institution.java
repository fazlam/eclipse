...
public class Institution {
	...
	public boolean equals(Object other) {
		System.out.println("running the equals method in Institution..");
		if (other instanceof Institution) {
			System.out.println("other is Institution chuck the propeties");
			Institution casted = (Institution) other;
			if (this.name.equals(casted.name) && this.place.equals(casted.place)
					&& this.location.equals(casted.location) && this.type.equals(casted.type)) {
			...
			System.err.println("other is not Institution,cennot check the propeties");
		}
